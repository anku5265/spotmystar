            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/30 rounded-xl p-4 hover:shadow-lg hover:shadow-purple-500/10 transition-all">
                ...
                {upcomingEvents.length > 0 ? (
                  ...
                  <div className="text-center py-12 bg-gray-900/30 rounded-lg border border-dashed border-purple-500/30">
              ...
              {/* PROFILE ANALYTICS */}
              <div className="bg-gradient-to-br from-pink-500/10 to-secondary/10 border border-pink-500/30 rounded-xl p-4 hover:shadow-lg hover:shadow-pink-500/10 transition-all">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-base font-bold text-white flex items-center gap-2">
