        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href={`${import.meta.env.VITE_ARTIST_PANEL_URL || 'http://localhost:5175'}/register`} className="block text-gray-400 hover:text-primary transition text-sm">Join as Artist</a>
