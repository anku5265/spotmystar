      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-gray-800/50 backdrop-blur-lg rounded-2xl border border-orange-500/30 p-8 shadow-2xl">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">Account Temporarily Inactive</h1>
            <p className="text-gray-300 text-lg mb-6">Your account has been temporarily deactivated by our admin team.</p>
            <div className="bg-gray-900/50 rounded-xl p-6 mb-6 border border-orange-500/20">
              <h3 className="text-orange-400 font-semibold mb-2 flex items-center justify-center gap-2">
                <Ban size={20} /> Reason for Deactivation
              </h3>
              <p className="text-gray-300">{reason || 'Policy violation detected'}</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="mailto:support@spotmystar.com" className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg hover:shadow-lg transition-all font-medium flex items-center justify-center gap-2">
                <Mail size={20} /> Email Support
              </a>
              <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 rounded-lg hover:shadow-lg transition-all font-medium flex items-center justify-center gap-2">
        ...
        <div className="max-w-2xl w-full bg-gray-800/50 backdrop-blur-lg rounded-2xl border border-yellow-500/30 p-8 shadow-2xl">
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-xl p-8 mb-6 border border-yellow-500/30">
              ...
              <div className="text-5xl font-bold text-white mb-2 font-mono">{timeRemaining}</div>
              <p className="text-gray-400 text-sm">Suspension ends: {new Date(suspensionEnd).toLocaleString()}</p>
            </div>
            <div className="bg-gray-900/50 rounded-xl p-6 mb-6 border border-yellow-500/20">
              <h3 className="text-yellow-400 font-semibold mb-2 flex items-center justify-center gap-2">
                <Ban size={20} /> Reason for Suspension
              </h3>
              <p className="text-gray-300">{reason || 'Terms of service violation'}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-gray-800/50 backdrop-blur-lg rounded-2xl border border-red-500/30 p-8 shadow-2xl">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">Account Terminated</h1>
            <p className="text-gray-300 text-lg mb-6">Your account has been permanently terminated due to serious policy violations.</p>
            <div className="bg-gray-900/50 rounded-xl p-6 mb-6 border border-red-500/20">
              <h3 className="text-red-400 font-semibold mb-2 flex items-center justify-center gap-2">
                <Ban size={20} /> Reason for Termination
              </h3>
              <p className="text-gray-300">{reason || 'Serious violation of terms of service'}</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="mailto:support@spotmystar.com" className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg hover:shadow-lg transition-all font-medium flex items-center justify-center gap-2">
                <Mail size={20} /> Email Support
